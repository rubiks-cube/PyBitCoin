...
def get_balance():
    ...
    if balance != None:
        response ={
            'message': 'Fetching balance succesful',
            'funds':balance
        }
...
def broadcast_block():
    ...
    if block['index'] == blockchain.chain[-1].index+1:
        ...
        response={
            'message':'blockchain seems to different from local blockchain'
        }
...
def mine():
    ...
    if  block != None:
        ...
        response = {
            'message': 'Adding a block successful',
