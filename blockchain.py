...
class Blockchain:
    """The Blockchain class manages the chain of blocks as well
     as open transactions and the node on which it's running.
                ...
                for node in self.__peer_nodes:
                    ...
                    try:
                        ...
                        if response.status_code == 400 or response.status_code== 500:
                            print('Transaction declined,resolve conflicts')
                            return False  
    ...
    def add_peer_node(self,node):
        """ Adds a new node to peer network set
        Arguments:
    ...
    def remove_peer_node(self,node):
         """ Remove a new node to peer network set
         Arguments:
